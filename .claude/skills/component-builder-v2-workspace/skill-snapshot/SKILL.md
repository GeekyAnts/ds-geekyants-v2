...
| [`components/v2/Button/`](../../../components/v2/Button/) | **The canonical reference component.** Mirror its shape exactly: `Button.tsx`, `button-variants.ts`, `Button.types.ts`, `Button.stories.tsx`, and `components/v2/lib/cn.ts`. |
...
| `references/composition-example.md` | When building a compound component (slots + context) — a worked Dialog-shaped example. |
