...
export const DarkMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Dialog content is portalled to <body>, so this story sets data-theme=\"dark\" and .dark on the documentElement (decorator) as well as the wrapper, proving the portalled popover surface re-themes from the same Tier-2 semantic overrides.",
      },
    },
  },
  decorators: [
