...
export const DarkMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Breadcrumb under a dark theme. The wrapper sets both data-theme="dark" and .dark; muted-foreground links and the foreground current page re-theme from Tier-2 semantics.',
      },
    },
  },
};
